...
class MultipleSkusDiscountPromotionCollectorStrategy implements DiscountPromotionCollectorStrategyInterface
{
    /**
    ...
    public function collect(
        ...
        foreach ($discountPromotionTransfer->getAbstractSkus() as $abstractSku) {
            ...
            if ($discountableItemTransfer) {
                $discountableItemTransfers[] = $discountableItemTransfer;
            }
        }
